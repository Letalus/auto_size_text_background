...
class AutoSizeTextWithBackground extends StatefulWidget {
  /// Creates a [AutoSizeTextWithBackground] widget.
  ///
  /// If the [style] argument is null, the text will use the style from the
  /// closest enclosing [DefaultTextStyle].
  const AutoSizeTextWithBackground(String this.data,
      {Key? key,
      this.textKey,
      this.style,
      this.strutStyle,
  ...
  const AutoSizeTextWithBackground.rich(TextSpan this.textSpan,
      {Key? key,
      this.textKey,
      this.style,
      this.strutStyle,
...
class _AutoSizeTextState extends State<AutoSizeTextWithBackground> {
  ...
  @override
  void didUpdateWidget(AutoSizeTextWithBackground oldWidget) {
    ...
    final layout =  LayoutBuilder(builder: (context, size) {
     ...
     /* final _newMaxWidth =
      ...
      if (style!.fontSize == null) {
        style = style.copyWith(fontSize: AutoSizeTextWithBackground._defaultFontSize);
      }
